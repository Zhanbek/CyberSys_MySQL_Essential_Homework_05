...
Зайдіть на веб-сайт w3school.com.

Використовуючи пошукові механізми w3school.com, знайдіть самостійно опис теми за кожним прикладом, розглянутим на уроці. Збережіть посилання та дайте їм короткий опис.
